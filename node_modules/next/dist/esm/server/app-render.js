...
import { NEXT_ROUTER_PREFETCH, NEXT_ROUTER_STATE_TREE, RSC, FLIGHT_PARAMETERS } from "../client/components/app-router-headers";
 ...
 */ function createErrorHandler(/**
   ...
   */ _source, capturedErrors, allCapturedErrors) {
    return (err)=>{
        ...
        if (err && (err.digest === DYNAMIC_ERROR_CODE || err.digest === NOT_FOUND_ERROR_CODE || err.digest === NEXT_DYNAMIC_NO_SSR_CODE || ((ref = err.digest) == null ? void 0 : ref.startsWith(REDIRECT_ERROR_CODE)))) {
            return err.digest;
        }
   ...
   */ const isStaticGeneration = renderOpts.supportsDynamicHTML !== true && !renderOpts.isBot;
     ...
     */ const getDynamicParamFromSegment = (// [slug] / [[slug]] / [...slug]
       ...
       */ const currentParams = // Handle null case where dynamic param is optional
            ...
            if (head) {
                ...
                return /*#__PURE__*/ React.createElement(DefaultHead, null);
            }
            return null;
        }
     ...
     */ const createComponentTree = async ({ createSegmentPath , loaderTree: [segment, parallelRoutes, { layout , template , error , loading , page , "not-found": notFound  }, ] , parentParams , firstItem , rootLayoutIncluded  })=>{
       ...
       */ const currentParams = // Handle null case where dynamic param is optional
            ...
            return {
                Component: ()=>{
                    return /*#__PURE__*/ React.createElement(React.Fragment, null, preloadedFontFiles.map((fontFile)=>{
                        ...
                        return /*#__PURE__*/ React.createElement("link", {
                    ...
                    }), stylesheets ? stylesheets.map((href, index)=>/*#__PURE__*/ React.createElement("link", {
                            rel: "stylesheet",
                            // In dev, Safari will wrongly cache the resource if you preload it:
                            // - https://github.com/vercel/next.js/issues/5860
                            // - https://bugs.webkit.org/show_bug.cgi?id=187726
                            ...
                            precedence: "high",
                            key: index
                        })) : null, /*#__PURE__*/ React.createElement(Component, Object.assign({}, props)));
                }
            };
        };
         ...
         */ const renderComponentsOnThisLevel = // No further router state available
                ...
                if (!parentRendered && renderComponentsOnThisLevel) {
                    return [
                        ...
                        isPrefetch && !Boolean(loaderTreeToFilter[2].loading) ? null : /*#__PURE__*/ React.createElement(React.Fragment, null, rscPayloadHead), 
                    ];
                }
