...
function appDirIssuerLayer(layer) {
    return layer === WEBPACK_LAYERS.client || layer === WEBPACK_LAYERS.server || layer === WEBPACK_LAYERS.appClient;
}
...
export function getDefineEnv({ dev , config , distDir , isClient , hasRewrites , isNodeServer , isEdgeServer , middlewareMatchers  }) {
    var ref, ref1, ref2;
    return {
...
export default async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =COMPILER_NAMES.server , appDir , middlewareMatchers , noMangling =false  }) {
    ...
    let webpackConfig = {
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: {
                            ...
                            mangle: {
                                ...
                                ...((ref45 = config.experimental.swcMinifyDebugOptions) == null ? void 0 : ref45.mangle) ?? {}
                            }
                        }
                    }).apply(compiler);
                },
        ...
        plugins: [
            ...
            hasAppDir && !isClient && !dev && new FlightTypesPlugin({
                dir,
            ...
            isClient && fontLoaderTargets && new FontLoaderManifestPlugin({
