...
async function build(dir, conf = null, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false) {
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
                ...
                try {
                    const [[verifyResult, typeCheckEnd]] = await Promise.all([
                        ...
                        shouldLint && nextBuildSpan.traceChild("verify-and-lint").traceAsyncFn(async ()=>{
                            var ref;
                            await (0, _verifyAndLint).verifyAndLint(dir, eslintCacheDir, (ref = config.eslint) == null ? void 0 : ref.dirs, config.experimental.cpus, config.experimental.workerThreads, telemetry, isAppDirEnabled && !!appDir);
                        }), 
                    ]);
            ...
            const rootPaths = (await (0, _flatReaddir).flatReaddir(rootDir, middlewareDetectionRegExp)).map((absoluteFile)=>absoluteFile.replace(dir, ""));
            ...
            const hasPages404 = (ref6 = mappedPages["/404"]) == null ? void 0 : ref6.startsWith(_constants.PAGES_DIR_ALIAS);
                ...
                await runWebpackSpan.traceAsyncFn(async ()=>{
                    ...
                    if (!serverResult.errors.length && !(edgeServerResult == null ? void 0 : edgeServerResult.errors.length)) {
                        _flightClientEntryPlugin.injectedClientEntries.forEach((value, key)=>{
                            ...
                            if (key === _constants1.APP_CLIENT_INTERNALS) {
                                clientEntry[_constants1.CLIENT_STATIC_FILES_RUNTIME_MAIN_APP] = [
                                    ...
                                    ...clientEntry[_constants1.CLIENT_STATIC_FILES_RUNTIME_MAIN_APP].import,
                                    value, 
                                ];
                            } else {
                                clientEntry[key] = {
                                    dependOn: [
                                        _constants1.CLIENT_STATIC_FILES_RUNTIME_MAIN_APP
                                    ],
                                    import: value
                                };
                            }
            ...
            const { customAppGetInitialProps , namedExports , isNextImageImported: isNextImageImported1 , hasSsrAmpPages: hasSsrAmpPages1 , hasNonStaticErrorPage ,  } = await staticCheckSpan.traceAsyncFn(async ()=>{
                ...
                await Promise.all(Object.entries(pageKeys).reduce((acc, [key, files])=>{
                    ...
                    return checkPageSpan.traceAsyncFn(async ()=>{
                        ...
                        if (!(0, _utils1).isReservedPage(page)) {
                            try {
                                let edgeInfo;
                                ...
                                if (pageType === "app" && originalAppPath) {
                                    ...
                                    if ((0, _isEdgeRuntime).isEdgeRuntime(pageRuntime)) {
                                        ...
                                        if (!(0, _utils).isDynamicRoute(page) && ((ref11 = workerResult.appConfig) == null ? void 0 : ref11.revalidate) !== 0) {
